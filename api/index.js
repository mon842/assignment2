...
app.post("/register", async (req, res) => {
  try {
    const { username, phone, password,city,email,gender,selectedOptions,state } = req.body;
    ...
    //create a new user
    const newUser = new User({ username, phone, password,city,email,gender,selectedOptions,state});
